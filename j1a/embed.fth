...
a: dboth   $0003 or a; ( stack remains, but top element changed - swap )
...
xchange _forth-wordlist _system
: rx?     rx?  0 -1 ; ( -- c t | -1 t : fetch a single character, or EOF )
...
: chars t>>1 ;              ( n -- n : convert bytes to number of cells )
